              ...
              <Card className="shadow-none border border-slate-200 dark:border-slate-700 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 transition-all duration-200">
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-amber-600 dark:text-amber-400 mt-1 flex items-center gap-1">
                    ...
                    <span className="font-medium">
                      ${usageData.price_per_truck.toFixed(2)}
                    </span>{" "}
                    per truck
                  </p>
                </CardContent>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <CardDescription className="text-slate-600 dark:text-slate-400">
                          Your truck loading optimization tool usage and
                          performance
                        </CardDescription>
                      </div>
                    </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-amber-700 dark:text-amber-300 mb-4">
                              Connect a payment method to start using Load Plan
                              Pro. You&apos;ll be charged $
                              {usageData.price_per_truck.toFixed(2)} per truck
                              loaded.
                            </p>
                      ...
                      {usageData.current_month_trucks > 0 ? (
                          ...
                          <div className="flex items-start space-x-3 p-3 rounded-lg bg-slate-50 dark:bg-slate-700/50">
                            ...
                            <div>
                              <p className="text-sm font-medium text-slate-900 dark:text-white">
                                {usageData.current_month_trucks} trucks loaded
                                this month
                              </p>
                              <p className="text-xs text-slate-500 dark:text-slate-400">
                                ${usageData.current_month_cost.toFixed(2)} in
                                charges
                              </p>
                            </div>
                          </div>
                              ...
                              <div>
                                ...
                                <p className="text-xs text-slate-500 dark:text-slate-400">
                                  ...
                                  {usageData.next_billing_date
                                    ? new Date(
                                        usageData.next_billing_date * 1000,
                                      ).toLocaleDateString()
                                    : "TBD"}
                                </p>
                              </div>
                        ...
                        <div className="text-center py-8">
                          ...
                          <p className="text-slate-600 dark:text-slate-400">
                            Start loading trucks to see your activity here
                          </p>
                        </div>
                      )}
                    </CardContent>
                          ...
                          <div className="flex items-start space-x-3 p-3 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-red-600 dark:text-red-400">
                                Connect payment to use Load Plan Pro
                              </p>
                            </div>
                          </div>
                        )}
                          ...
                          <div className="flex items-start space-x-3 p-3 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-amber-600 dark:text-amber-400">
                                {totalIncompleteOrders} orders need dimensions
                              </p>
                            </div>
                          </div>
                        )}
                            ...
                            <div className="flex items-start space-x-3 p-3 rounded-lg bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-green-600 dark:text-green-400">
                                  Ready to optimize truck loading
                                </p>
                              </div>
                            </div>
                          )}
                  ...
                  <CardHeader>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <CardDescription className="text-slate-600 dark:text-slate-400">
                          Track your Load Plan Pro usage and billing information
                        </CardDescription>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    ...
                    <div className="text-center py-8">
                      <p className="text-slate-600 dark:text-slate-400 mb-4">
                        For detailed billing management, visit your settings
                        page.
                      </p>
                      <Button
                        variant="outline"
              ...
              <TabsContent value="customers">
                <Card className="shadow-none border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
                  <CardHeader>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <CardDescription className="text-slate-600 dark:text-slate-400">
                          Manage your Load Plan Pro customers
                        </CardDescription>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    ...
                    <div className="text-center py-8">
                      <p className="text-slate-600 dark:text-slate-400 mb-4">
                        Manage your customers and their orders in the Load Plan
                        Pro tool.
                      </p>
                      <Button
                        onClick={() =>
                          (window.location.href =
                            "/dashboard/tools/load-plan-pro/customer")
                        }
                      >
                        View All Customers
                      </Button>
                  ...
                  <CardHeader>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <CardDescription className="text-slate-600 dark:text-slate-400">
                          Load Plan Pro performance metrics and insights
                        </CardDescription>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="space-y-6">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <span className="font-medium text-emerald-900 dark:text-emerald-100">
                              {customers.length > 0
                                ? (
                                    totalIncompleteOrders / customers.length
                                  ).toFixed(1)
                                : "0"}
                            </span>
                          </div>
                    ...
                    {usageData.total_trucks_loaded === 0 && (
                      <div className="text-center py-8">
                        ...
                        <p className="text-slate-600 dark:text-slate-400">
                          Start using Load Plan Pro to see detailed analytics
                          and insights
                        </p>
                      </div>
                    )}
